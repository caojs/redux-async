...
export default function componentCreator({ getIn, isEqual }) {
  class AsyncConnect extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
      return isEqual(this.state.propsToShow !== nextState.propsToShow);
    }
    ...
    isLoaded() {
      return getIn(this.context.store.getState(), ['reduxAsyncConnect', 'loaded']);
    }
